        ...
        <div className="container mx-auto text-center p-4">
          <div className="text-left mb-2">
            ...
            <p>If you want your sport, society or committee added to this page or want to update the details about it please
              {
                this.context?.username ? (
                  <span> <a href="mailto:grey.sportssocieties@durham.ac.uk?subject=Update%20Sport%20or%20Society%20Website%20Information" target="_blank" className="font-semibold underline" rel="noopener noreferrer">contact the Sports and Socs Officer by clicking here.</a></span>
                ) : (
