        ...
        <div className="container mx-auto text-center p-4">
          ...
          <div className="flex lg:flex-row flex-col lg:justify-between text-left">
            ...
            <div className="flex-grow flex flex-col mx-2 p-2 lg:w-1/2 border-2">
              ...
              <ul className="list-inside list-disc">
                <li>Assets reused from the <a href="https://github.com/ben-willis/grey-jcr/" target="_blank" rel="noopener noreferrer"><span className="mr-2 underline">previous Grey JCR Website</span></a></li>
