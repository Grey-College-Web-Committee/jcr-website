      ...
      <div className="flex flex-col justify-start">
        <div className="container mx-auto text-center p-4 md:w-3/5">
          ...
          <div className="text-justify p-2 border-b-2 border-red-900 mb-2">
            ...
            <div className="grid grid-cols-2 gap-2 md:grid-cols-5 md:gap-4 auto-rows-fr">
          ...
          <div className="flex flex-col md:flex-row text-justify md:border-b-2 md:border-red-900 md:mb-2">
            ...
            <div className="p-2 flex-1 border-b-2 border-red-900 mb-2 md:border-none md:mb-0">
              ...
              <h3 className="text-left font-semibold text-xl">Condoms</h3>
              <p className="mb-2">Condoms and lube are both free, and are available in a range of sizes and types, including female and latex-free. They can be picked up in drop-ins, from the box outside the Welfare room out of hours, or by messaging the anonymous online support system.</p>
            </div>
          </div>
